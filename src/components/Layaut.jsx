...
const Layout =({children}) =>{
    return(
      ...
      <div className="text-2xl font-mono font-bold text-purple-600">NielAdverse</div>
      <div className="flex font-mono font-bold">
        <a href="#" className="mr-4 no-underline text-white">Link 1</a>
        <a href="#" className="mr-4 no-underline text-white">Link 2</a>
        <a href="#" className="no-underline text-white">Link 3</a>
      </div>
    </header>
        <main>{children}</main>
        <footer className="bg-neutral-800 p-5 flex items-center justify-center border-t-4 border-t-purple-800 text-white">
        <div className="flex items-center justify-center ">
          <i className="m-2 cursor-pointer"><BsLinkedin/></i>
          <i className="m-2 cursor-pointer"> <BsTwitter/></i>
          <i className="m-2 cursor-pointer"> <BsTwitch/></i> 
        </div>
